...
module.exports = {
    ...
    return new promise(function (resolve, reject) {
      ...
      if (req.payload.request.body === null || req.payload.request.body == "") {
        ...
        if (req.payload.request.method === 'POST' || req.payload.request.method === 'PUT') {
          if (typeof req.payload.request.body.external_id === "undefined" || req.payload.request.body.external_id === "") {
            errormsg = gen_errormsg(errormsg, "External Id is missing from payload");
            rejectRequest = true;
          }
        }
      }
  ...
  validate_val_service_order: function (req) {
    return new promise(function (resolve, reject) {
      ...
      if (req.payload.request.body.external_id == undefined || req.payload.request.body.external_id == "") {
        errormsg = gen_errormsg(errormsg, "external_id cant be undefined or empty");
        rejectRequest = true;
      }
