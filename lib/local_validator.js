...
module.exports = {
  ...
  validate_values: function(req, type) {
    return new promise(function (resolve, reject) {
      ...
      if (req.payload.params.role == 'undefined') {
        if (type == "create") {
        ...
        if (type == "create" && allow_role.indexOf(req.payload.params.role) <= -1) {
          errormsg = errormsg + "Unknown [ "+ req.payload.params.role + " ] role, ";
          rejectRequest = true;
        }
      }
      ...
      if (req.payload.params.partner_id !== undefined) {
        if(validator.trim(req.payload.params.partner_id) == ""){
      ...
      if (req.payload.params.care_manager !== undefined) {
        if(validator.trim(req.payload.params.care_manager) == ""){
      ...
      if (req.payload.params.full_name !== undefined) {
        if(validator.trim(req.payload.params.full_name) == ""){
          errormsg = errormsg + "full_name can not be empty, ";
          rejectRequest = true;
        }
        var full_name = req.payload.params.full_name;
        ...
        if(type == "create" && req.payload.params.role == "CAREGIVER") {
      ...
      if (req.payload.params.first_name !== undefined) {
        if(validator.trim(req.payload.params.first_name) == ""){
        ...
        if(type == "create" && (req.payload.params.role == "MEMBER" || req.payload.params.role == "CAREMANAGER")) {
      ...
      if (req.payload.params.last_name !== undefined) {
        if(validator.trim(req.payload.params.last_name) == ""){
      ...
      if (req.payload.params.address1 === undefined) {
        if(type == "create" && req.payload.params.role == "MEMBER") {
          errormsg = errormsg + "Primary address is undefined, ";
          rejectRequest = true;
        }
      }else{
        if(type == "create" &&  validator.trim(req.payload.params.address1) === ""){
      ...
      if (req.payload.params.city !== undefined) {
        if(validator.trim(req.payload.params.city) == ""){
      ...
      if (req.payload.params.state !== undefined) {
        if(validator.trim(req.payload.params.state) == ""){
      ...
      if (req.payload.params.zipcode !== undefined) {
        if(validator.trim(req.payload.params.zipcode) == ""){
      ...
      if (req.payload.params.birthdate !== undefined) {
        if(validator.trim(req.payload.params.birthdate) == ""){
        ...
        if (!validator.isISO8601(req.payload.params.birthdate) || req.payload.params.birthdate.indexOf("-") <= -1) {
          //reject("Birth date should be in ISO8601 format");
      ...
      if (req.payload.params.phone != undefined && _.isObject(req.payload.params.phone) && !_.isEmpty(req.payload.params.phone)) {
        var mobile;
        var home;
        var office;
        if (req.payload.params.phone.mobile !== undefined && req.payload.params.phone.mobile != "") {
          mobile = req.payload.params.phone.mobile;
        ...
        if (req.payload.params.phone.home !== undefined && req.payload.params.phone.home != "") {
          home = req.payload.params.phone.home;
          home = home.replace(/-/g, "");
        ...
        if (req.payload.params.phone.office !== undefined && req.payload.params.phone.office != "") {
          office = req.payload.params.phone.office;
