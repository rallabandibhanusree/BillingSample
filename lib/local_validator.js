    ...
    return new promise(function (resolve, reject) {
      ...
      if (req.payload.request.body === null || req.payload.request.body == "") {
        ...
        if (req.payload.request.method === 'POST' || req.payload.request.method === 'PUT') {
          console.log('comparison block ', req.payload.request.body.external_id);
          if ((typeof req.payload.request.body.external_id === "undefined" || req.payload.request.body.external_id === "") && (typeof req.payload.request.body.cch_id === "undefined" || req.payload.request.body.cch_id === "")) {
