...
module.exports = {
    ...
    getUserProfileBasedOnReq: function (ws, req, reply, access_token){
        return new Promise(function (resolve, reject) {
            ...
            ws.search(search_string)
                .on('success', function (data, response) {
                    if (JSON.stringify(data) === '{}') {
                        ...
                        var result={}
                        result[profile_id] = {};
                        result[profile_id]["profile"] = data[profile_id]["profile"];
                        resolve(result); //could be result
                        //resolve(data); //resolve profile
                    }
                }).on('error', function (err) {
                if (search_string === "") {
    ...
    getAllUserProfileBasedOnReq: function (ws, req, reply, access_token){
        return new Promise(function (resolve, reject) {
            var search_string = "";
            var _cch_id = local_cache.get(access_token + "cch_id");
